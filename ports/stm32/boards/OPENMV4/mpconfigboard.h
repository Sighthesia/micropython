...
// UART3 config - 禁用以避免与摄像头I2C冲突
// 注意: PB10/PB11现在专门用于摄像头I2C2总线
/* ---------------------------------- 修改部分 ---------------------------------- */
// 原有UART3配置（与摄像头I2C冲突，已禁用）
...
// SPI buses
// 注意: SPI2引脚与用户引脚P0-P3有冲突，使用时需要注意
#define MICROPY_HW_SPI2_NSS (pin_B12)  // 与用户引脚P3冲突
#define MICROPY_HW_SPI2_SCK (pin_B13)  // 与用户引脚P2冲突
#define MICROPY_HW_SPI2_MISO (pin_B14) // 与用户引脚P1冲突
#define MICROPY_HW_SPI2_MOSI (pin_B15) // 与用户引脚P0冲突

// FDCAN bus
// 注意: CAN2引脚与用户引脚P2/P3有冲突，使用时需要注意
#define MICROPY_HW_CAN2_NAME "FDCAN2"
#define MICROPY_HW_CAN2_TX (pin_B13) // 与用户引脚P2冲突
#define MICROPY_HW_CAN2_RX (pin_B12) // 与用户引脚P3冲突
...
#define MICROPY_HW_LED2 (pin_C13) // green
#define MICROPY_HW_LED3 (pin_C13) // blue
#define MICROPY_HW_LED4 (pin_C13) // IR
